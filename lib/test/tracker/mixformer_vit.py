...
class MixFormer(BaseTracker):
    def __init__(self, params, dataset_name):
        ...
        print("Model loading from", self.params.checkpoint)
    ...
    def track(self, image, info: dict = None):
        ...
        # (384, 384, 3) 2.6853146853146854 (384, 384) (384, 384, 3) torch.Size([1, 3, 384, 384]) torch.Size([1, 3, 192, 192]) torch.Size([1, 3, 192, 192])
        ...
        with torch.no_grad():
            template, search, _, (out_dict, _) = self.network(self.template, self.online_template, search)
